    ...
    <header className="fixed inset-x-0 top-4 z-50 flex justify-center px-4 sm:px-6 transition-all duration-300">
      ...
      >
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="tel:9055606900" className="text-sm font-bold text-white bg-primary px-6 py-2.5 rounded-full hover:bg-primary-dark transition-all shadow-lg shadow-primary/20 flex items-center gap-2 hover:scale-105 active:scale-95">
