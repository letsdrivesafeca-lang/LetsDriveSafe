      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-2xl">
            ...
            >
              <a href="tel:9055606900" className="rounded-full bg-primary px-8 py-4 text-sm font-bold text-white hover:bg-primary-dark transition-all flex items-center gap-2 hover:scale-105 shadow-xl shadow-primary/20">
                Book a Lesson
              </a>
